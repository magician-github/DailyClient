<template>
  <div>
    <div class="header">
      ...
      <div style="height:60px;font-size:18px;background:#fff;border-radius:10px;padding:10px;box-shadow:10px 10px 10px #ddd">{{ (everyDay||'路漫漫其修远兮，吾将上下而求索')+'。'  }}</div>
      <img
        src="../assets/kz.jpg"
...
export default {
  ...
  methods: {
    async initEveryDay() {
      ...
      this.everyDay = resp.data.data[0].content;
    },
